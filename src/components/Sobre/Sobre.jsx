    ...
    <section id="sobre" className={styles.sobreContainer}>
      <div className={styles.contentBox}>
        ...
        <div className={styles.textContent}>
          <p>
            Desenho desde que me entendo por gente. Sempre gostei de criar no papel, testar ideias e usar a arte como forma de expressão. Com o tempo, percebi que a tatuagem é o caminho que quero seguir.
            ...
            Sou dedicada, pontual, tranquila, observo muito e me esforço pra sempre melhorar. Quero estar perto de quem leva a tatuagem a sério, como arte e profissão.         
            Sou comprometida, ética, curiosa e determinada a fazer da tatuagem o meu ofício.         
            Se você busca alguém dedicado e apaixonado por arte, estou pronta para começar.
          </p>
        </div>
